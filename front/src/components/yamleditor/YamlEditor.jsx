  ...
  render(){
    return(
      <section className={this.readOnly?"readOnly":""}>
        ...
        <MultipleChoice target={"nocite"} title="Citations" options={[{label:"All citations",value:"@*"},{label:"Only the ones used", value:""},{label:"test",value:"test"}]}  state={this.state.obj} updateState={this.updateState} readOnly={this.readOnly}/>
