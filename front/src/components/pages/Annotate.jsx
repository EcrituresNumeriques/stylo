...
export default function Annotate({ strategy: strategyId }) {
  ...
  const strategy = useMemo(() => strategies.get(strategyId), [strategyId])
  ...
  return (
    <>
      ...
      <section
        // biome-ignore lint/security/noDangerouslySetInnerHtml: the preview requires injecting the HTML generated by the Stylo export directly so that Hypothesis can annotate the rendered document
