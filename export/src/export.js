...
module.exports = {
  exportArticleHtml: async (req, res, next) => {
    try {
      ...
      exportHTML({ bib: cleanedVersion.bib, yaml: cleanedVersion.yaml, md: cleanedVersion.md, id: req.params.id, title: article._doc.title }, res, req)
  ...
  exportArticleZip: async (req, res, next) => {
    try {
      ...
      exportZIP({ bib: cleanedVersion.bib, yaml: cleanedVersion.yaml, md: cleanedVersion.md, id: req.params.id, title: article._doc.title }, res, req)
