...
Stylo est un éditeur de texte sémantique pour l’édition scientifique en lettres et en sciences humaines et sociales, piloté par l’équipe du [Laboratoire de recherche sur les écritures numériques](https://www.ecrituresnumeriques.ca/fr), et sous licence [GPL-3.0](https://github.com/EcrituresNumeriques/stylo/blob/master/LICENSE).
