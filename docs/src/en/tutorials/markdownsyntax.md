...
- definition
- question
- epigraph : use Métopes class *epigraph* available via right-click on the Stylo editor
- dedication : use Métopes class *dedication* available via right-click on the Stylo editor
