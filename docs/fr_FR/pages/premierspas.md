...
![Schéma de l'interface d'édition de Stylo](uploads/images/Schéma.png)
...
## Export
Le module d'export offre plusieurs formats (HTML5, XML, PDF, etc.). Il permet de choisir un style bibliographique et la présence ou non d'une table des matières.
...
2. **Raw Mode** : espace d'édition pour utilisateur avancé qui permet de modifier les champs d'entrées directement dans la structure du yaml.
